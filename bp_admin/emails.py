...
class AdminEmailListHandler(BaseHandler):
    def get(self):
        ...
        def pager_url(p, cursor):
            ...
            return self.uri_for('admin-emails-list', **params)
        ...
        return self.render_template('admin_emails_list.html', **params)


class AdminEmailViewHandler(BaseHandler):
    def get(self, email_id):
        try:
            ...
            if emaildata:
                ...
                return self.render_template('admin_email_view.html', **params)
        except ValueError:
            pass
        self.abort(404)
