...
1. Download the last version of the {SDK}[http://code.google.com/appengine/downloads.html#Google_App_Engine_SDK_for_Python] (Tested with SDK version 1.6.4).
1. Download the code for this Boilerplate ({here}[https://github.com/coto/gae-boilerplate/zipball/master])
1. Run locally ({instructions}[https://developers.google.com/appengine/docs/python/tools/devserver]).
1. Change the 'application' name ({here}[https://github.com/coto/gae-boilerplate/blob/master/app.yaml])
1. Upload it ({instructions}[https://developers.google.com/appengine/docs/python/gettingstarted/uploading])
...
- Language Detection (English and Spanish support, detecting the preferred user's language)
...
* Follow the {Google Python Style Guide}[http://google-styleguide.googlecode.com/svn/trunk/pyguide.html]
