= Google App Engine Boilerplate
 ...
 Check {the online demo}[http://appengine.protoboard.cl] out.
...
2. Download the last version of the {SDK}[http://code.google.com/appengine/downloads.html#Google_App_Engine_SDK_for_Python] (Tested with SDK version 1.6.4).
3. Run locally ({instructions}[https://developers.google.com/appengine/docs/python/tools/devserver]).
4. Change the 'application' name ({here}[https://github.com/coto/gae-boilerplate/blob/master/app.yaml])
5. Upload it ({instructions}[https://developers.google.com/appengine/docs/python/gettingstarted/uploading])
...
- Language Detection (English and Spanish support)
- Device identification (Automatically jQuery Mobile for Tablets and Smartphones, Bootstrap Template for Desktop)


== Technologies used (The latest)
* Python 2.7
...
* jQuery 1.7.2
* jQuery Mobile 1.0.1 for Mobile Version.
* {Twitter Bootstrap}[http://twitter.github.com/bootstrap/] Template for Desktop Version.


== Open Source
If you want add, fix or improve something, let us know with an {issue}[https://github.com/coto/gae-boilerplate/issues] or a Pull Request.
