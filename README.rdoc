...
If you don't know what is Google App Engine, I recommend before to watch {this video}[http://www.youtube.com/watch?v=bfgO-LXGpTM] and read {this website}[https://developers.google.com/appengine/].

Try it online {here}[http://appengine.protoboard.cl].


== Just 5 easy steps
1. Download the last version of the {App Engine SDK}[http://code.google.com/appengine/downloads.html#Google_App_Engine_SDK_for_Python] for Linux, Mac OS or Windows (Tested with SDK version 1.6.4).
...
* {HTML5Boilerplate}[http://html5boilerplate.com/] with {Modernizr 2.5.3}[http://modernizr.com]
* jQuery 1.7.1 and jQuery Mobile 1.1.0
* {Twitter Bootstrap 2.0.3}[http://twitter.github.com/bootstrap/] Template for Desktop Version.
