...
If you don't know what is Google App Engine, I recommend before to watch {this video}[http://www.youtube.com/watch?v=bfgO-LXGpTM] or read {this website}[https://developers.google.com/appengine/].
...
- Reset Password
- Update User Profile
- Automatic detection of user language (support for English, Spanish, Italian and Chinese)
...
== Open Source
If you want add, fix or improve something, let us creating an {issue}[https://github.com/coto/gae-boilerplate/issues] or a {Pull Request}[https://github.com/coto/gae-boilerplate/pull/new/master].
...
* {Jinja2 2.6}[http://jinja.pocoo.org/docs/] (A full featured template engine for Python).
