...
1. Chage to your 'application' name in {app.yaml}[https://github.com/coto/gae-boilerplate/blob/master/app.yaml]
...
* Code wrote with the {Google Python Style Guide}[http://google-styleguide.googlecode.com/svn/trunk/pyguide.html]
