...
1. Text to be translated should be enclosed in _("some text to translate") in *.py files.  In html templates translated text is indicated by:
  * {% trans %}some text to translate{% endtrans %}
