...
# Download the last version of the {SDK}[http://code.google.com/appengine/downloads.html#Google_App_Engine_SDK_for_Python] (Tested with SDK version 1.6.4).
# Run locally ({instructions}[https://developers.google.com/appengine/docs/python/tools/devserver]).
# Change the 'application' name ({here}[https://github.com/coto/gae-boilerplate/blob/master/app.yaml])
# Upload it ({instructions}[https://developers.google.com/appengine/docs/python/gettingstarted/uploading])
