...
1. Set parameters in config.py in the root directory.  (secret key, {recaptcha code}[http://www.google.com/recaptcha/whyrecaptcha], salt etc.)
...
== Acknowledgements
Google App Engine Boilerplate is a collaborative project which has kept alive thanks to the help of
