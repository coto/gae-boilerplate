...
class RegisterForm(PasswordMixin, ConfirmPasswordMixin, UserMixin, EmailMixin):
    pass


# mobile form does not require c_password as last letter is shown while typing and typing is difficult on mobile
class RegisterMobileForm(PasswordMixin, UserMixin, EmailMixin):
    pass
